...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'submit.commandPlaceholder': 'node',
    'submit.commandHelp': '실행할 명령어를 입력하세요 (예: node, python, npx)',
    'submit.arguments': 'Arguments',
    'submit.argumentsPlaceholder': 'build/index.js',
    'submit.argumentsHelp': '공백으로 구분된 인자들을 입력하세요',
    'submit.cwd': 'Working Directory (CWD)',
    'submit.cwdPlaceholder': '/path/to/working/directory',
    'submit.cwdHelp': '명령어를 실행할 작업 디렉토리 (선택사항)',
    'submit.addArguments': 'Add Arguments',
    'submit.addCwd': 'Add Working Directory',
    'submit.addEnv': 'Add Environment Variables',
    'submit.remove': '제거',
    'submit.envVars': 'Environment Variables',
    'submit.envKey': 'Key (예: API_KEY)',
    'submit.envValue': 'Value',
    'submit.addEnvVar': 'Add Variable',
    'submit.envHelp': 'MCP 서버에 전달할 환경 변수를 설정하세요 (API 키, 경로 등)',
    ...
    'edit.commandPlaceholder': 'node',
    'edit.commandHelp': '실행할 명령어를 입력하세요 (예: node, python, npx)',
    'edit.arguments': 'Arguments',
    'edit.argumentsPlaceholder': 'build/index.js',
    'edit.argumentsHelp': '공백으로 구분된 인자들을 입력하세요',
    'edit.cwd': 'Working Directory (CWD)',
    'edit.cwdPlaceholder': '/path/to/working/directory',
    'edit.cwdHelp': '명령어를 실행할 작업 디렉토리 (선택사항)',
    'edit.addArguments': 'Add Arguments',
    'edit.addCwd': 'Add Working Directory',
    'edit.addEnv': 'Add Environment Variables',
    'edit.remove': '제거',
    'edit.envVars': 'Environment Variables',
    'edit.envKey': 'Key (예: API_KEY)',
    'edit.envValue': 'Value',
    'edit.addEnvVar': 'Add Variable',
    'edit.envHelp': 'MCP 서버에 전달할 환경 변수를 설정하세요 (API 키, 경로 등)',
  ...
  en: {
    ...
    'submit.command': 'Command',
    'submit.commandPlaceholder': 'node',
    'submit.commandHelp': 'Enter the command to execute (e.g., node, python, npx)',
    'submit.arguments': 'Arguments',
    'submit.argumentsPlaceholder': 'build/index.js',
    'submit.argumentsHelp': 'Enter space-separated arguments',
    'submit.cwd': 'Working Directory (CWD)',
    'submit.cwdPlaceholder': '/path/to/working/directory',
    'submit.cwdHelp': 'Working directory to execute the command (optional)',
    'submit.addArguments': 'Add Arguments',
    'submit.addCwd': 'Add Working Directory',
    'submit.addEnv': 'Add Environment Variables',
    'submit.remove': 'Remove',
    'submit.envVars': 'Environment Variables',
    'submit.envKey': 'Key (e.g., API_KEY)',
    'submit.envValue': 'Value',
    'submit.addEnvVar': 'Add Variable',
    'submit.envHelp': 'Set environment variables to pass to the MCP server (API keys, paths, etc.)',
    'submit.serverConfig': 'Server Config (JSON)',
    'submit.serverConfigPlaceholder': '{"type": "streamable-http", "url": "http://localhost:3000"}',
    ...
    'submit.previewTools': 'Preview Tools',
    ...
    'edit.command': 'Command',
    'edit.commandPlaceholder': 'node',
    'edit.commandHelp': 'Enter the command to execute (e.g., node, python, npx)',
    'edit.arguments': 'Arguments',
    'edit.argumentsPlaceholder': 'build/index.js',
    'edit.argumentsHelp': 'Enter space-separated arguments',
    'edit.cwd': 'Working Directory (CWD)',
    'edit.cwdPlaceholder': '/path/to/working/directory',
    'edit.cwdHelp': 'Working directory to execute the command (optional)',
    'edit.addArguments': 'Add Arguments',
    'edit.addCwd': 'Add Working Directory',
    'edit.addEnv': 'Add Environment Variables',
    'edit.remove': 'Remove',
    'edit.envVars': 'Environment Variables',
    'edit.envKey': 'Key (e.g., API_KEY)',
    'edit.envValue': 'Value',
    'edit.addEnvVar': 'Add Variable',
    'edit.envHelp': 'Set environment variables to pass to the MCP server (API keys, paths, etc.)',
    'edit.serverConfig': 'Server Config (JSON)',
    'edit.serverConfigPlaceholder': '{"mcpServers": {"example": {"command": "python", "args": ["server.py"]}}}',
    ...
    'edit.previewTools': 'Preview Tools',

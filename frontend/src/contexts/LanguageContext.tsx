...
const translations: Record<Language, Record<string, string>> = {
  ko: {
    ...
    'submit.protocol': 'Protocol',
    'submit.protocolRequired': 'Protocol은 필수입니다.',
    'submit.protocolSelect': 'Select a protocol',
    ...
    'submit.serverUrlHelpStdio': 'MCP 서버 실행 명령어를 입력하세요. Protocol과 함께 입력하면 자동으로 tools를 미리보기합니다.',
    'submit.serverUrlHelpHttp': 'MCP Server의 URL을 입력하세요. Protocol과 함께 입력하면 자동으로 tools를 미리보기합니다.',
    ...
    'submit.connectionError': 'MCP Server에 연결할 수 없습니다. Server URL과 프로토콜을 확인하고 서버가 실행 중인지 확인해주세요.',
    'submit.stdioWarning': 'STDIO 프로토콜 안내:',
    'submit.stdioWarningDesc1': 'STDIO 프로토콜은 브라우저에서 직접 미리보기할 수 없습니다.',
    ...
    'edit.protocolRequired': 'Protocol은 필수입니다.',
    'edit.protocolSelect': 'Select a protocol',
    ...
    'edit.connectionError': 'MCP Server에 연결할 수 없습니다. Server URL과 프로토콜을 확인하고 서버가 실행 중인지 확인해주세요.',
    'edit.duplicateToolsTitle': '중복된 Tool이 발견되었습니다',
    'edit.duplicateToolsDesc': '동일한 이름의 tool이 이미 존재합니다. 어떤 것을 사용하시겠습니까?',
    'edit.existingTool': '기존 Tool',
    'edit.newTool': '새로운 Tool',
    'edit.keepExisting': '기존 것 유지',
    'edit.replaceWithNew': '새로운 것으로 교체',
    'edit.stdioWarning': 'STDIO 프로토콜 안내:',
    'edit.stdioWarningDesc1': 'STDIO 프로토콜은 브라우저에서 직접 미리보기할 수 없습니다.',
  ...
  en: {
    ...
    'submit.descriptionPlaceholder': 'Describe your MCP server...',
    'submit.protocol': 'Protocol',
    'submit.protocolRequired': 'Protocol is required.',
    'submit.protocolSelect': 'Select a protocol',
    'submit.serverUrl': 'Server URL',
    'submit.serverUrlInvalid': 'Please enter a valid URL.',
    'submit.serverUrlPlaceholderStdio': 'python stdio_test_mcp_server.py',
    'submit.serverUrlPlaceholderHttp': 'http://localhost:3000',
    'submit.serverUrlHelpStdio': 'Enter the MCP server run command. When entered with Protocol, tools will be previewed automatically.',
    'submit.serverUrlHelpHttp': 'Enter the MCP Server URL. When entered with Protocol, tools will be previewed automatically.',
    'submit.serverConfig': 'Server Config (JSON)',
    'submit.serverConfigPlaceholder': '{"type": "streamable-http", "url": "http://localhost:3000"}',
    ...
    'submit.parameters': 'Parameters:',
    'submit.required': 'required',
    'submit.connectionError': 'Cannot connect to MCP Server. Please check the Server URL and protocol, and ensure the server is running.',
    'submit.stdioWarning': 'STDIO Protocol Notice:',
    'submit.stdioWarningDesc1': 'STDIO protocol cannot be previewed directly in the browser.',
    ...
    'edit.protocol': 'Protocol',
    'edit.protocolRequired': 'Protocol is required.',
    'edit.protocolSelect': 'Select a protocol',
    'edit.serverUrl': 'Server URL',
    ...
    'edit.connectionError': 'Cannot connect to MCP Server. Please check the Server URL and protocol, and ensure the server is running.',
    'edit.duplicateToolsTitle': 'Duplicate Tools Found',
    'edit.duplicateToolsDesc': 'Tools with the same name already exist. Which would you like to use?',
    'edit.existingTool': 'Existing Tool',
    'edit.newTool': 'New Tool',
    'edit.keepExisting': 'Keep Existing',
    'edit.replaceWithNew': 'Replace with New',
    'edit.stdioWarning': 'STDIO Protocol Notice:',
    'edit.stdioWarningDesc1': 'STDIO protocol cannot be previewed directly in the browser.',
